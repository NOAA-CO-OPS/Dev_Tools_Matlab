...
% structure with fields that correspond to the data retrieved. More
...
% CO-OPS' data servers. To account for this, the pause() function is implemented 
...
%             time of year
%             Default is 'gmt'
% Interval  > The interval for met data.  This only applies to met data
%             that is not the APi defualt of 6 minute.
%             'h' - hourly met data
...
for i=1:length(DatesB)
    ...
    %Pause for 3 seconds between API requests
    pause(3)
end
